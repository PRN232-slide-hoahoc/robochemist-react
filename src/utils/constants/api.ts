...
export const API_ENDPOINTS = {
  ...
  EXAM: {
    ...
    EXAM_EXPORT_QUESTIONS: (examId: string) => `/exam/v1/exams/${examId}/export/questions`,
    EXAM_EXPORT_ANSWERS: (examId: string) => `/exam/v1/exams/${examId}/export/answers`,
    MATRICES_BASE: '/exam/v1/matrices',
    MATRICES_NAMES: '/exam/v1/matrices/names',
    MATRIX_BY_ID: (id: string) => `/exam/v1/matrices/${id}`,
    QUESTIONS_BULK: '/exam/v1/Question/bulk',
    QUESTIONS: '/exam/v1/Question',
    QUESTION_BY_ID: (id: string) => `/exam/v1/Question/${id}`,
  },
  SLIDES: {
  ...
  WALLET: {
    ...
    WALLET_BALANCE: '/wallet/v1/wallet/balance',
    WALLET_PAYMENT: '/wallet/v1/wallet/payment',
    WALLET_REFUND: '/wallet/v1/wallet/refund',
    WALLET_DEPOSIT: '/wallet/v1/wallet/deposit',
    WALLET_DEPOSIT_CALLBACK: '/wallet/v1/wallet/deposit-callback',
    TRANSACTIONS_BY_REFERENCE: (referenceId: string) => `/wallet/v1/wallet/transactions/reference/${referenceId}`,
  },
} as const;
